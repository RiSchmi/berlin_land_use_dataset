...
# 2. Green Volume Index (GVI_{radius}) for radius in radii
...
# 3. emitter related features, traffic volume index (tvi_{radis}), proportion heavy vehicle, nearest street, nearest intersection, population
...
# 4. construct 'prop_intercept_200', 'prop_intercept_50', border_values
# FILE NOT IN REPOSITORY, PLS ADD FIRST
try:
    ...
    print('building shapefile for street canyon no found, pls add first')
    sites_coord = pd.concat([sites_coord, features_green, features_emitter], axis=1)
